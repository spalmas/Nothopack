...
#' @param HD1 Dominant height (m) of the stand at future projection time (required for projections).
#' @param N1 Number of trees (trees/ha) of the stand at future projection time (required for projections).
